...
REF_WORK_DIR_PATH="${HOME}/work/ubuntu-iso-builder-import-pacstall-kde-plasma-theme-jasper"
...
echo "[Next Step]: cd ~/work/ubuntu-iso-builder-import-pacstall-kde-plasma-theme-jasper/iso-profile
"
echo
